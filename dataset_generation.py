...
class BasicSynchronousClient(object):
    ...
    def setup_camera(self,img_num,init_x,init_y,deg):
        """
        ...
        file = os.path.join("/Users/abour/OneDrive/Bureau/WindowsNoEditor/PythonAPI/examples/dataset", 'IMG-' + str(img_num) )
        ...
        try:
            ...
            for i in range (4):
                ...
                for degrees in range(0, 360, 15):
                    ...
                    self.setup_camera(img_num,x,y,degrees)
                    tt=0
